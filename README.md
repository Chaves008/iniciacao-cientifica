# 📒 Tecnologias para Transformação Social: Aplicação de experimentações de Computação Física para o Suporte e Reintegração de Jovens que passaram por medidas Socioeducativas.
